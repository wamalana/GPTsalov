...
POLICY={'schema':1,'environment':'testnet','symbol':SYMBOL,'budget':'50',
        ...
        'max_drawdown':str(L.MAX_DRAWDOWN),'stop_model':VERSION,'notional_cap':str(L.NOTIONAL_CAP),'min_rr':'1','max_trades':20,
        'max_positions':3,'duration_ms':604800000,'hold_ms':14400000,'config_hash':CFG.fingerprint}
